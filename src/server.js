...
createServer({
    ...
    seeds(server){
        ...
        server.create("snack", {id: "3", name: "Siomai", pricePhP: 5, description: "Siomai is a Filipino adaptation of Chinese dumplings, usually made with ground pork, shrimp, or beef wrapped in thin wonton wrappers. Steamed to perfection, it’s served hot with a side of soy sauce, calamansi, and chili garlic for dipping. A street food staple, it’s affordable, filling, and loved for its savory bite-sized goodness.", imageUrl: "https://ik.imagekit.io/maminickz/snacks/siomai.png", type: "street-food"})
        server.create("snack", {id: "4", name: "Rambutan", pricePhP: 0.10, description: "Rambutan is a tropical fruit popular in the Philippines, easily recognized by its hairy red-and-green skin. Inside, it reveals a juicy, translucent flesh that’s sweet with a slight tartness, similar to lychee. Often sold by street vendors in bunches, it’s a refreshing treat enjoyed fresh on hot days.", imageUrl: "https://ik.imagekit.io/maminickz/snacks/rambutan.png", type: "fruit"})
        server.create("snack", {id: "5", name: "Lumpia", pricePhP: 3, description: "Lumpia roll is a beloved Filipino street food made of thin crepes or wrappers filled with a savory mix of vegetables, meat, or both. It’s rolled tightly, deep-fried to a golden crisp, and enjoyed with a sweet and tangy dipping sauce. Crunchy and flavorful, it’s a go-to merienda that’s both filling and budget-friendly.", imageUrl: "https://ik.imagekit.io/maminickz/snacks/lumpia-roll.png", type: "street-foods"})
    ...
    routes(){
        ...
        this.get("/snacks/:id", (shcema, request) => {
            const id = request.params.id
            return this.schema.snacks.find(id)
        })
    }
})
